...
** DONE ~:~ unary prefix operator takes in a type and returns a type expression
...
DONE [2023-12-20 Wed 11:47]

** DONE ~#~ unary prefix operator: "sizeof"
...
[2023-12-20 Wed 10:58]
I've decided I want to start out with the ~sizeof~ keyword as the unary
prefix operator, instead of the symbol ~#~.
