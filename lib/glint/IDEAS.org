* Append w/ Iterator Fixup
keywords: iterator, container, feature

A way to append to a container and pass along references to any iterators you'd like "fixed up", if they were invalidated by the append. Also the same with erasure. Also the same with indices instead of iterators.
...
keywords: iterator, error, container
