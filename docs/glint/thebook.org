...
# "What is the name of the first variable declared in the above program"
# "how many variables are declared"
# "what is the value of initialized variable 'x' when the program starts vs when the program finishes
# "what is the type of the third variable declared"
...
#+begin_src glint
  vector_push : void(vec : vector auto.element, val : auto.element) {
